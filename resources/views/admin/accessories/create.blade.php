<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Administration / Ajouter un accessoire') }}
        </h2>
    </x-slot>
            ...
            <form action="{{ route('admin.accessories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                    ...
                    <div class="bg-emerald-900 px-8 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-medium text-white">Nouvel Accessoire</h3>
                        <span class="text-xs text-emerald-200 uppercase tracking-widest">Vente libre</span>
                    </div>
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <p id="file-name" class="mt-2 text-sm text-emerald-600 font-medium text-center h-5"></p>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="name" class="block w-full rounded-lg border-gray-300 shadow-sm py-2.5" type="text" name="name" :value="old('name')" required />
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4" class="block w-full rounded-lg border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm" placeholder="Caractéristiques, compatibilité, matériaux...">{{ old('description') }}</textarea>
                    ...
                    <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex items-center justify-end gap-4">
                        ...
                        <button type="submit" class="inline-flex items-center px-6 py-3 bg-emerald-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 transition shadow-lg">Enregistrer</button>
                    </div>
